from abc import ABC, abtsractclassmethod, abstractproperty
...
class Conta:
  ...
  def sacar(self.valor):
      ...
      if excedeu_saldo:
          ...
          print("\nOperação falhou! O valor infromado é inválido")
...
def criar_cliente(clientes):
    ...
    data_nascimentp = input("Informe a data de nascimento (dd-mm-aaaa): ")
